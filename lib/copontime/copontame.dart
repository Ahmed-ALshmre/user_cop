...
import 'package:cobonapp_flutter/anmeted/cobetext.dart';
import 'package:cobonapp_flutter/model/model.dart';
import 'package:cobonapp_flutter/tools/anmeted.dart';
...
class CopTime extends StatefulWidget {
  final ItemModel model;

  const CopTime({Key key, this.model}) : super(key: key);
  @override
  _CopTimeState createState() => _CopTimeState();
}

class _CopTimeState extends State<CopTime> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return bodHome(context: context);
  }
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            right: EcommerceApp.sharedPreferences
                                        .getString("la") !=
                                    null
                                ? 0
                                : 80,
                            left: EcommerceApp.sharedPreferences
                                        .getString("la") !=
                                    null
                                ? 80
                                : 0),
                        child: AnimatedWidgetWidget(
                          onpres: () {
                            burstParticles();
                            FlutterClipboard.copy('efg1')
                                .then((value) => print('copied'));
                            Fluttertoast.showToast(msg: "لقد تم نسخه الكود");
                          },
                        ),
                      ),
                    ],
